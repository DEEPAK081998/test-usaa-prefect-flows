...
SELECT
    ...
    CAST(pup.data::json->'agent' AS TEXT) AS has_an_agent,
    CAST(pup.data::json->'loFirstName' AS TEXT) AS loFirstName,
    CAST(pup.data::json->'loLastName' AS TEXT) AS loLastName,
    CAST(pup.data::json->'prequal' AS TEXT) AS prequal,
    CAST(pup.data::json->'sell' AS TEXT) AS is_selling,
    CAST(pup.data::json->'agentFirstName' AS TEXT) AS agent_first_name,
    CAST(pup.data::json->'agentLastName' AS TEXT) AS agent_last_name,
    partner_id,
    first_name,
    last_name,
    email,
    CAST(pup.data::json->'sofi'->>'partyId' AS TEXT) as sofi_party_id,
    CAST(pup.data::json->'sofi'->>'leadId' AS TEXT) as sofi_lead_id,
