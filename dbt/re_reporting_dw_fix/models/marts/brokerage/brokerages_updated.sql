...
, leads_brokerage_cte AS (
    SELECT
        ...
        {% if target.type == 'snowflake' %}
        (DATEDIFF(second, '1970-01-01', ua1.agent_assign_time_unadjusted) - DATEDIFF(second, '1970-01-01', fat.RC_accept_time_unadjusted)) /60/60 as AgentAssign_Time_Delay_Hrs,
        {% else %}
