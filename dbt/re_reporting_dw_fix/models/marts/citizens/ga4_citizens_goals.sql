...
select 
    ...
    SUM(CASE WHEN eventname = 'Lead_submitted_Home_Page' THEN conversions ELSE 0 END) as homestory_lead_submitted_home_page
 from {{ source('public', 'ga4_citizens_ga_goals_final_v2') }}  
