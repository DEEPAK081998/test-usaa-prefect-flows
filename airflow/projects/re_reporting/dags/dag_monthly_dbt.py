...
from airflow_dbt_python.operators.dbt import DbtRunOperator, DbtRunOperationOperator
...
def execute_dbt_run(**kwargs):
    ...
    dbt_run = DbtRunOperationOperator(
...
with DAG(
    ...
    airbyte_connection_sync >> dbt_run_task
